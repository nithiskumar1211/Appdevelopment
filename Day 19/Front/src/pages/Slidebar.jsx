...
const Slidebar = () => {
  ...
  return (
    ...
    <div className='sli7'><h onClick={()=>{navigate('/Dashboard6')}} style={{width:"12vw",height:"6vh",color:'white',cursor:'pointer'}}>Report</h><ReportIcon style={{width:'3vw',height:"3vh",color:"pink"}}/></div>
